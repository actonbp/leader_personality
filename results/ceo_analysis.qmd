...
sns.heatmap(results_df[trait_columns], annot=True, cmap='RdYlBu', center=0.5,
...
plt.figure(figsize=(12, 6))
sns.barplot(data=results_df.sort_values('Neuroticism', ascending=False), x='Name', y='Neuroticism')
